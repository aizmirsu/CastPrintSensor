...
//  CastPrintSensor
//
//  Created by Uvis Štrauss on 26/01/2020.
...
class ScanController: UIViewController, STBackgroundTaskDelegate, MeshViewDelegate, UIGestureRecognizerDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
	...
	func registerNotificationHandlers() {
		...
		NotificationCenter.default.addObserver(self, selector: #selector(ScanController.appDidBecomeActive), name: UIApplication.didBecomeActiveNotification, object: nil)
	}
