...
extension ScanController: STSensorControllerDelegate {
    ...
    func startStructureSensorStreaming() {
        ...
        if _useColorCamera {
            ...
            if _options.useHardwareRegisteredDepth {
                ...
                do {
                    try _sensorController.startStreaming(options: [kSTStreamConfigKey: STStreamConfig.depth320x240.rawValue, kSTColorCameraFixedLensPositionKey: _options.lensPosition])
