...
// swiftlint:disable line_length identifier_name type_body_length explicit_init force_unwrapping
...
open class MeshViewController: UIViewController, UIGestureRecognizerDelegate, MFMailComposeViewControllerDelegate {
    ...
    func colorizeMesh() {
        ...
        _ = delegate?.meshViewDidRequestColorizing(self.mesh!, previewCompletionHandler: {
